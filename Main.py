...
# from Backend.ImageGeneration import main
...
def InitialExecution():
    SetMicrophoneStatus("False")  # Ensure mic OFF on program start
    ShowTextToScreen("")
    ...
    if G and R : #or R:
        ...
        for Queries in Decision:
            if "general " in Queries:
                ...
                Queries = "Okay, Bye!"
                Answer = ChatBot(QueryModifier(Queries))
                ShowTextToScreen(f"{Assistantname} : {Answer}")
                SetAssistantStatus("Answering...")
                TTS(Answer)
                SetAssistantStatus("Answering...")
...
def FirstTread():
    while True:
        ...
        print(f"DEBUG: Mic status read: '{CurrentStatus}'")  # <-- Debug print
